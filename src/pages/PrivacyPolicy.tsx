      ...
      <main className="flex-1 py-16 md:py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <h2>Refund Policy</h2>
            <p>
              <strong>All Sales are Final.</strong> Because the nature of our product involves immediate digital delivery and consumption of expensive AI computing resources, we offer <strong>no refunds</strong> on one-time credit purchases or subscription payments once they have been processed. You may cancel your subscription at any time to prevent future billing.
            </p>

            <h2>Copyright Act & Intellectual Property</h2>
            <p>
              All original content generated by the AI on behalf of the user remains the property of the user. However, the software, design, text, algorithms, and logos of ClassCraft Presentations are protected by international Copyright Acts and intellectual property laws. Unauthorized reproduction, resale, or distribution of the software is strictly prohibited.
            </p>
